      ...
      {selectedCourse ? (
        ...
        <div className="p-4 sm:p-6 2xl:p-8 max-w-7xl 2xl:max-w-[1600px] mx-auto">
          <div className="mb-4 sm:mb-6">
            <h1 className="text-2xl sm:text-3xl 2xl:text-4xl font-bold text-foreground mb-2">Welcome to Your Dashboard</h1>
            <p className="text-sm sm:text-base 2xl:text-lg text-muted-foreground">Select a course from the sidebar to view details and assignments</p>
          </div>
          <Card>
